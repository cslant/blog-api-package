 ...
 */
class AuthorGetFiltersAction extends Action
{
    ...
    #[
        Get(
            path: "/authors/filters",
            operationId: "authorGetWithFilters",
    ...
    The default number of items per page is 10 and the default page number is 1. You can change these values by passing the `per_page` and `page` query parameters.
            ",
            summary: "Get authors by filters with pagination",
            tags: ["Author"],
            parameters: [
                new Parameter(
                    name: 'order_by',
